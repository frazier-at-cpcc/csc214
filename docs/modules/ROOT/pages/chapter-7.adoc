...
[[sec-7-3]]
== 7.3 Frequency Analysis and Text Classification
...
[[sec-7-6]]
== 7.6 Named Entity Recognition and Entity Linking
...
[[sec-7-7]]
== 7.7 Sentiment Analysis and Language Detection
...
[[sec-7-8]]
== 7.8 Speech Recognition and Speech Synthesis
...
=== 7.8.1 Speech Recognition (Speech-to-Text)
...
=== 7.8.2 Speech Synthesis (Text-to-Speech)
...
[[sec-7-10]]
== 7.10 Conversational Language Understanding (CLU)
...
[[sec-7-11]]
== 7.11 Conversational AI and Knowledge Bases
