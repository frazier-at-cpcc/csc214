...
=== 4.2.3 Step 3 — Evaluate and Iterate
...
=== 4.4.2 Linear Regression: A Core Algorithm
...
=== 4.4.3 Data Splitting Strategies
...
=== 4.4.4 Evaluation Metrics for Regression
...
=== 4.4.5 The Iterative Nature of Model Development
...
=== 4.5.3 Evaluation Metrics for Binary Classification
...
=== 4.5.4 Multiclass Classification
...
=== 4.6.3 Evaluation Metrics for Clustering
...
=== 4.7.1 How a Neural Network Works
...
=== 4.7.3 ML vs. Deep Learning: Key Differences
...
[[sec-4-8]]
== 4.8 Choosing the Right ML Technique
