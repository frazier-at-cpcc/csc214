...
[[sec-6-1]]
== 6.1 Overview of Computer Vision
...
[[sec-6-2]]
== 6.2 Azure Computer Vision Services
...
[[sec-6-3]]
== 6.3 Computer Vision Capabilities
...
[[sec-6-4]]
== 6.4 How Computer Vision Works: Pixels and Image Representation
...
=== 6.4.1 Pixels as the Building Blocks
...
=== 6.4.3 Color Images and RGB Channels
...
[[sec-6-5]]
== 6.5 Image Filters and Convolutional Filtering

=== 6.5.1 What Is a Filter?
...
=== 6.6.1 How Classification Works
...
=== 6.7.2 How Object Detection Differs from Classification
...
[[sec-6-8]]
== 6.8 Optical Character Recognition (OCR)
...
=== 6.8.1 Traditional OCR vs. AI-Powered OCR
...
[[sec-6-10]]
== 6.10 Convolutional Neural Networks (CNNs)
...
[[sec-6-11]]
== 6.11 From CNNs to Multimodal Models
...
=== 6.11.1 The Rise of Transformers
...
=== 6.11.3 Capabilities of Multimodal Models
...
[[sec-6-12]]
== 6.12 Responsible AI and Computer Vision
